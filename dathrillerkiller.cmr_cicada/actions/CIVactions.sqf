...
/*ROB*/
[player,["Rob Safe","scripts\bankrob.sqf", ["robDialog", safe1],1,false,true,"","player distance Safe1 <= 3"]]call action_add;
...
[player,["Process Oil","scripts\itemprocess.sqf",["Oil", "OilBarrel", 2, "oil"],1,false,true,"","player distance Oil_1 <= 5"]]call action_add;
[player,["Process Wheat","scripts\itemprocess.sqf",["getreide", "Bread", 2, "Baker"],1,false,true,"","player distance bakery <= 5"]]call action_add;
[player,["Process Strawberries","scripts\itemprocess.sqf",["straw", "Frozens", 3, "Baker"],1,false,true,"","player distance bakery <= 5"]]call action_add;
[player,["Process LSD","scripts\itemprocess.sqf",["Unprocessed_LSD", "lsd", 5, "lsdga1"],1,false,true,"","player distance gangarea1 <= 5"]]call action_add;
[player,["Process Cocaine","scripts\itemprocess.sqf",["Unprocessed_Cocaine", "cocaine", 5, "cocainega1"],1,false,true,"","player distance gangarea1 <= 5"]]call action_add;
[player,["Process LSD","scripts\itemprocess.sqf",["Unprocessed_LSD", "lsd", 5, "lsdga2"],1,false,true,"","player distance gangarea2 <= 5"]]call action_add;
[player,["Process Heroin","scripts\itemprocess.sqf",["Unprocessed_Heroin", "heroin", 5, "heroinga2"],1,false,true,"","player distance gangarea2 <= 5"]]call action_add;
[player,["Process Heroin","scripts\itemprocess.sqf",["Unprocessed_Heroin", "heroin", 5, "heroinga3"],1,false,true,"","player distance gangarea3 <= 5"]]call action_add;
[player,["Process Marijuana","scripts\itemprocess.sqf",["Unprocessed_Marijuana", "marijuana", 5, "marijuanaga3"],1,false,true,"","player distance gangarea3 <= 5"]]call action_add;
[player,["Process Heroin","scripts\itemprocess.sqf",["Unprocessed_Heroin", "heroin", 5, "heroinga4"],1,false,true,"","player distance gangarea4 <= 5"]]call action_add;
[player,["Process Marijuana","scripts\itemprocess.sqf",["Unprocessed_Marijuana", "marijuana", 5, "marijuanaga4"],1,false,true,"","player distance gangarea4 <= 5"]]call action_add;
...
[player,["Shop 3 Export","noscript.sqf",'[ (shop4 call shops_index)]call shops_openshop; ',1,false,true,"","player distance shop4export <= 3"]]call action_add;
